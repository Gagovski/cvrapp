...
public class StopPreviewCommand extends Command {

    private MediaListener mListener;

    public StopPreviewCommand(Cvr cvr, MediaListener listener) {
        super(cvr);
        mListener = listener;
    }
    ...
    public void encodeCommand(ByteBuffer b) {
        encodeCommand(b, CvrConstants.CommandCode.StopPreview);
    }
    ...
    @Override
    public short code() {
        return CvrConstants.ResponseCode.StopPreview;
    }
